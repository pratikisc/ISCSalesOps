---
Old View: '"commissions"."invoice-w001-t003-attribution"'
New View: '"commissions"."invoice-w001-t003-attribution-v2"'
---
new
```sql
...
LEFT JOIN "commissions"."invoice-w001-t003-geo-attribution-v2" AS b ON a.identifier = b.identifier
